...
\textbf{Elearning Academy}  \hspace{2em} \textsl{Guide: Prof. Kameswari Chebrolu} \hspace{5em} \textbf{Summer 2014}
\vspace{-3.5mm}
\begin{list2}
\item An implementation of the flipped classroom model developed in Django
\item Currently being used by nearly 10,000 teachers and students in the country 
...
\begin{list2}
\item Member of the team (of four) that stood second runners up in \textsl{Hackcon '14}, Microsoft's national hacking contest, among nearly 250 teams from all over the country
\item Winner at \textsl{code.fun.do}, a hackathon held by Microsoft at IIT Bombay in Spring 2014
...
\textsl{Trumplab}\\
Designed a web platform for connecting teachers to students.
